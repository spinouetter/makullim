...
// 좌석맵 자리(오른쪽): injectSeatmap이 이 rect 위치·크기에 좌석 히트맵을 그림 — 크기 4/5로 축소
const smW = 258*0.8, smH = 262*0.8;
heading("SEAT MAP", 566, bandTop + 14, smW, 12.5);
P(`<rect id="fn-seatbox" x="566" y="${(bandTop + 24).toFixed(1)}" width="${smW.toFixed(1)}" height="${smH.toFixed(1)}" fill="none"/>`);
